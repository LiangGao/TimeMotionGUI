...
class App:
    def __init__(self, master):
        ...
        VisitTypes = ['All', '1','2','3','4'];
        self.VisitType.set(VisitTypes[0])
        Visit_Type = OptionMenu(master, self.VisitType, *VisitTypes)        
        
        lbl_Type_ID = Label(master, text="Select exam type:",
                            wraplength=100, anchor='w', justify='left')
        self.ExamType = StringVar(master)
        ExamTypes = ['All', '1-(Review and Exam)','2-(Discussion)','3-(Prescriptions)',
...
if __name__ == '__main__':
    root = Tk()
    root.title("Time-motion Workflow Data Analysis Tool v0.6")
